    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
            <div class="logo"><img src="assets\images\favicon-icon\24x24.png" <a href="index.php"><b>ONLINE BIKE ZONE</b> </a> </div>
        </div>
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:info@example.com">Onlinebikezone@gmail.com</a> </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Service Helpline Call Us: </p>
              <a href="tel:61-1234-5678-09">+91-9677561659</a> </div>
...
echo "Welcome To Online  Bike Zone portal";
 } ?>
          </div>
        </div>
      </div>
	 ...
	 echo htmlentities($result->FullName); }}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="bike-listing.php">Used Bikes</a>
            <li><a href="book.php">service details</a></li>
