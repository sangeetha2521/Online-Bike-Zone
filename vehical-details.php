...
$status=0;
$vhid=$_GET['vhid'];
$sql="INSERT INTO  tblbooking(userEmail,VehicleId,FromDate,ToDate,probdesc,address,Status) VALUES(:useremail,:vhid,:fromdate,:todate,:probdesc,:address,:status)";
...
$query->bindParam(':address',$message,PDO::PARAM_STR);
...
<title>Online Bike Zone Port | Vehicle Details</title>
<!--Bootstrap -->
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap">
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              ...
              <li role="presentation"><a href="#accessories" aria-controls="accessories" role="tab" data-toggle="tab">Features</a></li>
            </ul>
