...
<head>
	...
	<title>Online Bike Zone Portal | Admin Edit Vehicle Info</title>
...
<label for="inlineCheckbox1"> cooling System-Air Cooled </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="airconditioner" value="1">
<label for="inlineCheckbox1"> ABS</label>
</div>
<?php } ?>
</div>
<div class="col-sm-3">
...
<label for="inlineCheckbox2"> Self Start  </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-success checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="powerdoorlocks" value="1">
<label for="inlineCheckbox2"> Digital Speedaameter </label>
</div>
<?php }?>
</div>
<div class="col-sm-3">
...
<label for="inlineCheckbox3"> stroke-4mm </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="antilockbrakingsys" value="1">
<label for="inlineCheckbox3"> front,back breakes</label>
</div>
<?php } ?>
</div>
<div class="col-sm-3">
...
<label for="inlineCheckbox3"> tubless tire </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="brakeassist" value="1">
<label  for="inlineCheckbox3"> Alloy weels </label>
</div>
<?php } ?>
</div>
...
<label for="inlineCheckbox1"> mileage(50kmpl)</label>
</div>
<?php } else {?>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="powersteering" value="1">
<label for="inlineCheckbox1"> single owner</label>
</div>
<?php } ?>
</div>
<div class="col-sm-3">
...
<label for="inlineCheckbox2">max speed-112kmph</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
